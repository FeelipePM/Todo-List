...
function recuperar(){
    let formulario = document.querySelector('.login-usuario');
    formulario.textContent = '';
    formulario.innerHTML = "<h3 class='login'>Recuperar senha</h3><input type='email' class='form-control' id='email' placeholder='E-mail cadastrado' required><button type='submit' class='btn btn-default' id='login'>Recuperar</button>";
    enviadoSucesso();
    event.preventDefault();
}
